...
<%
	...
	try {
		...
		String sql = "select t.checkv, t.screen_id, t.seat_num, t.customer_id, t.showing_date, t.showing_time, s.cinema_name, m.title from ticket t				join screen s	on s.id = t.screen_id		join movie m		on s.movie_id = m.id		where t.customer_id = ?;";
		pstmt = conn.prepareStatement(sql);
		pstmt.setString(1, hs.getAttribute("id").toString());
	...
	<table>
		...
		<%
			...
			<tr>
				...
				%>
				<form action="back_reservation.jsp" method="post">
					...
					<td><input type="submit" value="결제취소"></td>
				</form>
